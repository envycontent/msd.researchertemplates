...
def setup_product():
    ...
    import msd.researchertemplates
    zcml.load_config('configure.zcml', msd.researchertemplates)
    ...
    ztc.installPackage('msd.researchertemplates')
...
setup_product()
ptc.setupPloneSite(products=['msd.researchertemplates'])
